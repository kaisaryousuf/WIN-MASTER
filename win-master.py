...
def privCheck():
   ...
   command(keypath + "secretsdump.py -k " + DOM.rstrip(" ") + " -just-dc")
   print("")
...
while True: 
   ...
   checkParams = 0							# RESET
   checkFile = ""							# RESET
   LTM = getTime(COL1)							# GET CLOCK TIME
   command("clear")							# REFRESH SCREEN
   display()								# DISPLAY UPPER
   options()								# DISPLAY LOWER
   selection=input("[*] Please select an option: ")			# USER CHOICE
   ...
   if selection == '13':
      ...
      if checkParams != 1:
         ...
         try:      
            ...
            print(colored("[!] WARNING!!! - Unable to enumerate network address, trying ping instead...", colour1))
   ...
   if selection == '46':
      ...
      if checkParams != 1:       
         ...
         if count > 0:
            ...
            with open("DATAFILES/hashes.txt", "r") as force:
               for brute in force:
                  brute = brute.rstrip("\n")             
