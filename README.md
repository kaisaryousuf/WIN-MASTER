...
|------     |------            | -------                          | ----    |
| python3   | WinMaster.py     | 22363856d54355c2577aaae8b1ce5e63 | Forest  |
...
- [x] Requires Windapsearch (https://github.com/ropnop/windapsearch) to be installed in the /usr/share/doc/python3-impacket/examples/ directory.
        ...
        AclPwn (https://pypi.org/project/aclpwn/) requires BloodHound (https://github.com/BloodHoundAD/BloodHound) and Neo4j
        (https://github.com/neo4j) to be installed.
